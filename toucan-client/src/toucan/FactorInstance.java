...
/**
 * Title: FactorInstance
 * Description: An instance of a factor (see Factor class) on a sequence. Something like a GFF record.
...
public class FactorInstance {
  ...
  public FactorInstance() {
  }

  public int instanceStrand,instanceStart,instanceStop;
  public double instanceScore;
  public double instanceNormScore=0;
