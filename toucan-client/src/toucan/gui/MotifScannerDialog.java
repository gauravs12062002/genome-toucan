...
/**
 * Title: MotifScannerDialog
 * Description: Dialog to run the MotifScanner service
...
public class MotifScannerDialog
    extends JDialog
  ...
  public MotifScannerDialog(MainFrame window) {
    super(window, "MotifScanner Web Service", true);
    owner = window;
    ...
    JLabel label6 = new JLabel("P3: Prior (double)");
    ...
    txt6 = new JTextField("0.1", 20); //prior
      ...
      if (e.getSource() == ok) {
        if (txt5.getText().equalsIgnoreCase("") ||
          ...
          if (!txt6.getText().equals("")) {
            sr.setPrior(new Double(txt6.getText()).
                        doubleValue());
          }
